...
impl TMsgServiceProcessFunctions {
  pub fn process_hello<H: MsgServiceSyncHandler>(handler: &H, incoming_sequence_number: i32, i_prot: &mut dyn TInputProtocol, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
...
impl MsgServiceHelloArgs {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<MsgServiceHelloArgs> {
    i_prot.read_struct_begin()?;
...
impl MsgServiceHelloResult {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<MsgServiceHelloResult> {
    i_prot.read_struct_begin()?;
