...
use rs::{MsgServiceSyncHandler, MsgServiceSyncProcessor, Message};
...
fn run() -> thrift::Result<()> {
    ...
    let processor = MsgServiceSyncProcessor::new(MsgServiceHandlerImpl { });
